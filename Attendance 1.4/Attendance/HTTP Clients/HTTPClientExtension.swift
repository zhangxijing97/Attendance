...
extension HTTPClient {
    ...
    func getTrackStudentForTrack(data: HTTPClient, track: Track) -> [TrackStudent] {
    ...
    func getStudentForTrack(data: HTTPClient, track: Track) -> [Student] {
    ...
    func getTrackStudentForStudent(data: HTTPClient, student: Student) -> [TrackStudent] {
        let trackstudents = data.trackstudents.compactMap { trackstudent in
    ...
    func getTrackForStudent(data: HTTPClient, student: Student) -> [Track] {
        let trackstudents = data.getTrackStudentForStudent(data: data, student: student)
